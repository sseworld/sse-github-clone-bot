// const TelegramBot = 6062400015:AAEYGB3TL55gffIZzaDdQ8kdb1b2UlCuHco
...
const token = "6062400015:AAEYGB3TL55gffIZzaDdQ8kdb1b2UlCuHco";
...
bot.onText(/\/start/, (msg) => {
  ...
  bot.sendPhoto(chatId, imageUrl, {
    caption: "Welcome to the SSE GitHub Clone Bot! 🤖",
  });

  const keyboard = {
    inline_keyboard: [[{ text: "Developer", url: "https://sseworld.com" }]],
  };

  bot.sendMessage(
    chatId,
    "You can clone a GitHub repository using this bot. Just send me the repository URL.\nType /help - For Help Menu",
    {
...
bot.onText(/\/clone (.+)/, async (msg, match) => {
  ...
  try {
    ...
    bot.sendMessage(
      chatId,
      "Repository cloned successfully! Zipping the files... ⌛️"
    );
    ...
    bot.sendMessage(
      chatId,
      "Files zipped successfully! Uploading the ZIP file... ⌛️"
    );
    ...
    bot.sendMessage(
      chatId,
      "ZIP file uploaded successfully! Cleaning up... ⌛️"
    );
    ...
    bot.sendMessage(
      chatId,
      "An error occurred while cloning the repository. Please try again later."
    );
  }
});
